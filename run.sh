...
echo "[run.sh] RANK=$RANK_ARG WORLD_SIZE=$WORLD_SIZE_VALUE PREFILL_MODE=$PREFILL_MODE_TEXT BANDWIDTH=$BANDWIDTH_TEXT BATCH_SIZE=$BATCH_SIZE SPLIT_LAYERS=$SPLIT_LAYERS SCHEDULER_CSV=$SCHEDULER_CSV INIT_METHOD=$INIT_METHOD COMPUTE_DEVICE=$COMPUTE_DEVICE"
